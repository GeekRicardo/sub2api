...
func TestMigrationsRunner_IsIdempotent_AndSchemaIsUpToDate(t *testing.T) {
	...
	requireColumn(t, tx, "usage_logs", "response_body", "text", 0, true)
	requireColumn(t, tx, "usage_logs", "response_body_truncated", "boolean", 0, false)
	requireColumn(t, tx, "usage_logs", "response_body_bytes", "integer", 0, true)
